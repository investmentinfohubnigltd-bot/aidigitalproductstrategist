...
const products = [
  ...
  { num: '03', name: 'InsightEx', desc: 'A financial intelligence dashboard covering equities, FX, macro, and fixed income — delivering automated daily market data.', category: 'Fintech', url: 'insightex.app', href: 'https://insightex.app' },
